...
public class TelaPrincipalEscola extends javax.swing.JInternalFrame {
    ...
    private void btn_CadastrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_CadastrarMouseClicked
        ...
        view_EscolaCadastro escolaCadastro=new view_EscolaCadastro();
        gerenteView.abrirTela(escolaCadastro);
    ...
    private void txtPesquisaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPesquisaKeyPressed
        ...
        try {
            ...
            for (int i = 0; i < escolas.size(); i++) {
                ...
                if (escolas.get(i).getRazaoSocial().length() >= nomePesquisa.length()) {
                    String list = escolas.get(i).getRazaoSocial().substring(0, quat);

                    if (nomePesquisa.equalsIgnoreCase(list)) {

                        String dados[] = {
                            escolas.get(i).getCnpj(),
                            escolas.get(i).getRazaoSocial(),
                            escolas.get(i).getEndereco().getLogradouro() + " "
                            + escolas.get(i).getEndereco().getNumero() + " "
                            + escolas.get(i).getEndereco().getBairro() + " "
                            + escolas.get(i).getEndereco().getMunicipio() + "- "
                            + escolas.get(i).getEndereco().getUf() + " "
                            + escolas.get(i).getEndereco().getCep(),
                            escolas.get(i).getTelefone(),
                            escolas.get(i).getEmail()};
